...
$faqs = [
    ...
    [
        'question' => "<h2>Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?
        </h2>",
    ...
    [
        'question' => "<h2>Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?
        </h2>",
        'answer' => "<p>In alcuni casi sì. Quando fai clic su un risultato della Ricerca Google, il tuo browser web potrebbe reindirizzare alla pagina web di destinazione 
